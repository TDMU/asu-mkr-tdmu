...
class DefaultController extends AdminController
{
    ...
    {
        return GSuiteDirectoryModel::GSuiteUserInfo($uemail);
    }
    
    public function actionGsuiteDeleteUser($uemail)
    {
        return GSuiteDirectoryModel::GSuiteDeleteUser($uemail);
    }

    //insert or update Google Directory User Account
    public function GSuiteUpdateUser($user, $type)
    {
        return GSuiteDirectoryModel::GSuiteUpdateUser($user, $type);
    }
    ...
    private function getStudentFaculty2Directory($st1){
        return GSuiteDirectoryModel::getStudentFaculty2Directory($st1);
    }
}