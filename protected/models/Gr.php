...
SQL;
    ...
    /**
     * Список потоков by specilalty
     * @param $f1
     * @param $course
     * @return array
     */
    public function getStreamForSpec($f1, $speciality, $course)
    {
        if (empty($f1) || empty($course))
            return array();
        ...
        $sql=<<<SQL
           SELECT sg4, sem4, gr7,gr3,gr1, gr19,gr20,gr21,gr22,gr23,gr24,gr25,gr26, sg1
			from sp
			   ...
			   inner join ucxg on (ucgn.ucgn1 = ucxg.ucxg2)
			WHERE ucxg1<30000 and gr13=0 and gr6 is null
				 and sp5=:FACULTY and sp1 =:SPECIALITY and sem3=:YEAR1 and sem5=:SEM1 and ucgns5=:YEAR2 and ucgns6=:SEM2 and sem4=:COURSE
			GROUP BY sg4, sem4, gr7,gr3,gr1, gr19,gr20,gr21,gr22,gr23,gr24,gr25,gr26, sg1
			ORDER BY gr7,gr3
SQL;
...
SQL;
    ...
    public static function getTimeTable($id, $date1, $date2,$type)
    {
        ...
        {
                case 0:
                        $sql ='SELECT * FROM RAGRST(:LANG, :ID, 0, 0, 0, 0, :DATE_1, :DATE_2) ORDER BY r2,r3,rz2';
                        break;
                case 1:
                        $sql ='SELECT * FROM RAGRST(:LANG, 0, :ID, 0, 0, 0, :DATE_1, :DATE_2) ORDER BY r2,r3,rz2';
                        break;
                case 2:
                        $sql ='SELECT * FROM RAGRST(:LANG, 0, 0, 0, :ID, 0, :DATE_1, :DATE_2) ORDER BY r2,r3,rz2';
                        break;
                case 3:
